...
var myXTCMacro = {
   ...
   arc:function(theta1, theta2){
      ...
      var i    = parseFloat(((carousel.r*Math.cos(theta1))-carousel.x).toFixed(2)); // (Xc-(R*cos(Theta1)))-Xc   
      var j    = parseFloat(((carousel.r*Math.sin(theta1))-carousel.y).toFixed(2)); // (Yc-(R*sin(Theta1)))-Yc   
